...
export default function Contact() {
  ...
  return (
    <Paper ref={ref} className={`bg-[#f8f8f8] w-full py-[80px] ${styles.body}`}>
            ...
            <div className={classes.fields}>
              ...
              <Group justify="center">
                <input
                  type="submit"
                  value="Send Now"
                  className="bg-primary border-2 border-primary rounded-md hover:bg-transparent hover:text-primary mt-[20px] px-4 py-2.5 text-[16px] transition duration-300 text-white cursor-pointer"
                />
              </Group>
            </div>
